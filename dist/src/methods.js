...
function _toConsumableArray(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = Array(arr.length); i < arr.length; i++) arr2[i] = arr[i]; return arr2; } else { return Array.from(arr); } } /* eslint-disable no-inline-comments,sort-keys */
...
exports.default = {
  ...
  listAliases: { version: '>=3.0.5' },
  listAssetAllocations: { version: '>=3.0.5' },
  listAssetAllocationTransactions: { version: '>=3.0.5' },
  listAssets: { version: '>=3.0.5' },
  listCerts: { version: '>=3.0.5' },
  listEscrows: { version: '>=3.0.5' },
  listOffers: { version: '>=3.0.5' },
